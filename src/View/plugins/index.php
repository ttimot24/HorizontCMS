...
<h1>Plugin manager <div class='pull-right'><a id='upl' class='btn btn-primary' data-toggle='modal' data-target='.upload_plugin'>
<i class='fa fa-upload'></i>&nbspUpload new plugin</a></div></h1></br>
...
foreach($data['all_plugin'] as $current_plugin){
