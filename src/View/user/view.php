...
<section class='row'>
<h2 class='col-md-8'>User view</h2>
...
<a class='btn btn-link' data-toggle='modal' data-target='.<?= $data['instance']->id ?>-modal-xl'>
  <img src=<?= $data['instance']->get_image() ?> class='img img-thumbnail' style='margin-top:20px;' >
</a>

</br><center>
  <div class='btn-group' role='group'>
    <a href='<?= $data['instance']->id ?>' type='button' class='btn btn-success'><span class='glyphicon glyphicon-star' aria-hidden='true'></span> Deactivate</a>
    <a href='admin/user/update/<?= $data['instance']->id ?>' type='button' class='btn btn-warning'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span> Edit user</a>
  </div>    
    ...
    </br></br><b>Full name : <a><?= $data['instance']->name ?></a></b>
    </br></br><b>Username : <a><?= $data['instance']->username ?></a></b>
    </br></br><b>Rank : <a><?= $data['instance']->get_rank()->name ?></a></b>
     </br></br><b>Email : <a><?= $data['instance']->email ?></a></b>
    </br></br><b>Registered on : </br><a><?= date("Y.m.d - H:i:s",$data['instance']->reg_date) ?></a></b>
     </br></br><b>Logins : <a><?= $data['instance']->visits ?></a></b>
     <hr/>
    </center>
</div>
...
<?php   
  ...
  if($data['instance']->active==0){

     $datediff = $data['instance']->reg_date - time();
  ...
  foreach($data['blogposts'] as $each){
    ...
    "delete",
    "Are you sure?",
    "<b>Delete this user: </b>".$data['instance']->username." <b>?</b>",
    "<a href='admin/user/delete/".$data['instance']->id."' type='button' class='btn btn-danger'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span> Delete</a>
