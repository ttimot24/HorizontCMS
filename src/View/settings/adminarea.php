...
<img class='well well-sm' src='<?= $SYSTEM->get_admin_logo(); ?>' onerror='this.src=\"storage/images/logos/world.png\"' height='100'>
...
<tr><td>Language</td><td><select name='language' class='form-control' style='width:100%;'>
              ...
              <?php 
                ...
                foreach($data['languages'] as $language){
                  ...
                  if($language == $data['current_language']){
...
<?php             
        $logos = scandir(Storage::$path."/images/logos");
	        ...
	        foreach (array_slice($logos,2) as $each){
	        	print "<a href='admin/settings/setlogo/admin_logo/".$each."'><img src='".Storage::$path."/images/logos/".$each."' class='img img-thumbnail settings-image' width='150'></a>";
	        }
?>
