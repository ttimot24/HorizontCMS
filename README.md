...
[![Laravel 6](https://img.shields.io/badge/Laravel-7-orange.svg)](http://laravel.com)
...
HorizontCMS is an open-source, responsive Content Management System (CMS) built on Laravel 7, VueJs 2.6 and Bootstrap 3.4 which you can use to build you next generation websites and blogs.
