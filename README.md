...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/d645b6be9b6a42a8b6189cc32ea8f546)]()

Lightweight CMS built on Laravel 5.3. The core system can be simply extended by themes and plugins with one click. Easy to learn for users, simple to code for developers.

There are a lot of work here still.

### Latest version: [v1.0.0-alpha.6](https://github.com/ttimot24/HorizontCMS/releases/tag/v1.0.0-alpha.6)
