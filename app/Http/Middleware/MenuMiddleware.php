        ...
        \Menu::make('RightMenu', function($menu) {
           ...
           // $menu->add('current_user', $request->user()->username)->id('current_user');
            ...
            if(\Auth::user()->hasPermission("settings")){
                ...
                $menu->find('shutdown')->add("<i class='fa fa-lock'></i> ".trans('navbar.lock_screen'), ['url'=>'#', 'onclick'=>'event.preventDefault();','data-target'=>"#lock_screen",'data-toggle'=>"modal",'data-backdrop'=>'static','data-keyboard'=> 'false'])->id('lock_screen');
