    ...
    public function handle($request, Closure $next){
        ...
        \Menu::make('RightMenu', function($menu) use ($request) {
            ...
            if(\Auth::user()->hasPermission("settings")){
                ...
                $menu->find('shutdown')->add("<i class='fa fa-lock'></i> ".trans('navbar.lock_screen'), ['url'=>'#', 'onclick'=>'event.preventDefault();localStorage.locksession=\'true\'','data-bs-target'=>"#lock_screen",'data-bs-toggle'=>"modal",'data-backdrop'=>'static','data-keyboard'=> 'false'])->id('lock_screen');
