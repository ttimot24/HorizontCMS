...
<form action='{{admin_link("settings-save")}}' role='form' method='POST'>
   ...
   <table class='table-bordered' id='settings' style='width:100%;text-align:center;'>
      <tbody style='font-weight:bolder;'>
         <tr class="d-flex">
            <td class='col-4 p-2'>Title</td>
            <td class="col-8"><input type='text' class='form-control' name='title' value="{{$settings['title']}}" placeholder="What you write here, will be the name of the browser page."></td>
         </tr>
         <tr class="d-flex">
         ...
         <tr class="d-flex">
            ...
            <td class="col-8">
               <div class='form-group col-xs-12 col-md-8 d-flex m-4'>
