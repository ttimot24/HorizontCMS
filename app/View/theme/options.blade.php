    ...
    <div class='container'>
        ...
        <div class="d-flex align-items-start pt-4">
            <div class="nav flex-column nav-pills me-3 col-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link active" id="v-pills-style-tab" data-bs-toggle="pill" data-bs-target="#v-pills-style"
                    type="button" role="tab" aria-controls="v-pills-style" aria-selected="true">Custom style</button>
                <button class="nav-link" id="v-pills-translate-tab" data-bs-toggle="pill"
                    data-bs-target="#v-pills-translate" type="button" role="tab" aria-controls="v-pills-translate"
                    aria-selected="false">Translations</button>
            </div>
            <div class="col-10">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-translate" role="tabpanel"
                        ...
                        <form action="{{ config('horizontcms.backend_prefix') . '/theme/update-translations/' . $theme }}"
                            method="POST">
                            @csrf
