<div>
    ...
    <div id="filemanager" data-start="{{ $current_dir }}">
                    ...
                    <form action="{{ route('filemanager.store') }}" method='POST' enctype='multipart/form-data'
                        ...
                        <div class='modal-body'>
                            ...
                            <div class='form-group'>
                                ...
                                <input name='up_file[]' id='input-2' type='file' class='file'
        ...
        <div class='modal rename_modal' id='rename_sample' tabindex='-1' role='dialog'
            aria-labelledby='rename_file' aria-hidden='true'>
            <div class='modal-dialog'>
                <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            ...
                            <div class='form-group'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' name='old_name' id="selected"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <div class='form-group'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' name='new_name' id="selected"
                                        required>
                                </div>
                            </div>
