...
<div class='form-group pull-left col-xs-12 col-md-8' style='margin-top:20px;margin-bottom:20px;'>
        <div class="radio radio-primary radio-inline">
                        <input type="radio" id="inlineRadio1" value="1" name='website_debug' <?php if($settings['debug_mode']==1){echo "checked"; } ?>>
                        <label for="inlineRadio1">On</label>
        </div>

                    <div class="radio radio-inline">
                        <input type="radio" id="inlineRadio2" value="0" name='website_debug' <?php if($settings['debug_mode']==0){echo "checked"; } ?>>
