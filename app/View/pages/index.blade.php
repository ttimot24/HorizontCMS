            ...
            <tbody id="pages">
                ...
                @foreach ($all_pages as $each)
                    ...
                    echo "
                            ...
                            <td><img src='" .
                        $each->getThumb() .
                        "' width='70' height='50' class='img img-rounded' /></td>
                            <td>" .
                        $each->name .
                        "</td>
                            <td>" .
                    ...
                    echo "<td class='ps-4'><span class='badge rounded-pill bg-dark'>" .
                        $each->subpages->count() .
                        "</span></td>
                        ...
                        <td class='text-center'>
                           <div class='btn-group' role='group'>
                               <a href='" .
                        route('page.edit', ['page' => $each]) .
                        "' type='button' class='btn btn-warning btn-sm' style='min-width:70px;'>" .
                        trans('actions.edit') .
                        "</a>
                               <a  type='button' data-bs-toggle='modal' data-bs-target='#delete_" .
                        $each->id .
                    ...
                    <div class="modal mo-' .
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        trans('actions.close') .
                        '</button>
                            <a href="admin/page/set-home-page/' .
                        $each->id .
