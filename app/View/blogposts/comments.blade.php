    ...
    <table class='table table-hover'>
        ...
        <tbody>
            ...
            @foreach ($blogpost->comments->reverse() as $comment)
                <tr>
                    <td class='col'><img class='img-rounded' src='{{ $comment->user->getThumb() }}' width='70'>
                    </td>
                    <td class='col'><a
                    ...
                    <td class="text-center">
                        <div class='btn-group col' role='group'>
                            ...
                            <a type='button' data-bs-toggle='modal' data-bs-target='#delete_{{ $comment->id }}'
                ...
                <form action="{{ route('blogpostcomment.store') }}" method='POST'>
                    ...
                    <div class='modal-body'>
                        <h5 style='font-weight:bolder;'>{{ trans('comment.write_as') }}: <a
                            ...
                            <img src='{{ $user->getThumb() }}' class='img img-rounded pull-right' width='30'>
                        </h5>
