                ...
                <div class="panel-body" style="color:black;">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/password/reset') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" pattern=".{6,}" type="password" class="form-control" name="password" required>
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" pattern=".{6,}" type="password" class="form-control" name="password_confirmation" required>
