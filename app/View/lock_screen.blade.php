<div class='modal fade' id='lock_screen' role='dialog' v-on:keydown.enter="unlock('{{ \Auth::user()->id }}');"
    ...
    <div class='modal-dialog modal-lg'>
        <div class='modal-content'>
            ...
            <div class='modal-body text-center'>
                ...
                <div>
                    <img src="{{ \Auth::user()->getThumb() }}" class='img-thumbnail'
            ...
            <div class='modal-footer'>
                <button type='button' id='unlock_button' class='btn btn-primary'
                    onclick="lockscreen.unlock('{{ \Auth::user()->id }}');">{{ trans('actions.unlock') }}</button>
            </div>
        </div>
    </div>
</div>
