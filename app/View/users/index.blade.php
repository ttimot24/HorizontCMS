...
?>
       ...
       <div class='btn-group' role='group'>
          ...
          <a type='button' data-bs-toggle='modal' data-bs-target='#delete_{{$each->id}}' class='btn btn-danger btn-sm {{$disabled}}' {{$disabled}}><i class='fa fa-trash-o' aria-hidden='true'></i></a>
