    ...
    public function run()
    {
        ...
        DB::table('user_roles')->insert([
         ...
         DB::table('user_roles')->insert([
            'name' => 'Admin',
            'permission' => 5,
            'rights' => json_encode(['admin_area', 'upgrade', 'blogpost','blogpostcategory','blogpostcomment','user','userrole','page','theme','plugin','filemanager','headerimage','schedule','search','settings']),
        ]);
