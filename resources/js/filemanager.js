...
var fileamanager = new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
  name: 'FileManager',
  el: '#filemanager',
  mounted: function mounted() {
    var _this = this;
  ...
  methods: {
    ...
    returnFileUrl: function returnFileUrl(filepath) {
      console.log((ckeditor4_vue__WEBPACK_IMPORTED_MODULE_0___default()));
      try {
        // Simulate user action of selecting a file to be returned to CKEditor.
        var funcNum = 1; /*getUrlParam( 'CKEditorFuncNum' );*/
        var fileUrl = filepath;
        ckeditor4_vue__WEBPACK_IMPORTED_MODULE_0___default().config.tools.callFunction(funcNum, fileUrl, '');
        window.close();
      } catch (e) {
        console.log((ckeditor4_vue__WEBPACK_IMPORTED_MODULE_0___default()));
        console.log(e);
