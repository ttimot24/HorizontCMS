...
var LockScreen = /*#__PURE__*/function () {
  function LockScreen() {
    _classCallCheck(this, LockScreen);
    this.modal = new bootstrap__WEBPACK_IMPORTED_MODULE_2__.Modal(document.getElementById('lock_screen'));
  }
  _createClass(LockScreen, [{
    key: "lockUpScreenMounted",
    value: function lockUpScreenMounted() {
    ...
    key: "unlock",
    value: function unlock(userId) {
      var _this = this;
      var pwd = jquery__WEBPACK_IMPORTED_MODULE_0__("#lock_pwd").val();
