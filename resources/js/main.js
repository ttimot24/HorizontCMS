...
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.headers.common["Content-Type"]) = "application/json";
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.headers.common.Accept) = "application/json";
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.headers.common["X-CSRF-TOKEN"]) = csrfToken.getAttribute('content');
