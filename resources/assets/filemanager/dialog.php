        ...
        foreach ($files as $nu => $file_array) {
            ...
            $file_prevent_rename = false;
				...
				<figcaption>
					...
					<?php 
                } elseif (($is_video || $is_audio) && in_array($file_array['extension'], $jplayer_ext)) {
                    ?>
					...
					href="javascript:void('');" ><i class=" icon-eye-open"></i></a>
						<?php 
                } elseif ($preview_text_files && in_array($file_array['extension'], $previewable_text_file_exts)) {
                    ?>
						...
						href="javascript:void('');" ><i class=" icon-eye-open"></i></a>
						<?php 
                } elseif ($googledoc_enabled && in_array($file_array['extension'], $googledoc_file_exts)) {
                    ?>
						...
						<?php 
                } elseif ($viewerjs_enabled && in_array($file_array['extension'], $viewerjs_file_exts)) {
                    ?>
